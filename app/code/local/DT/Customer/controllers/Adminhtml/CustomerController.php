...
class DT_Customer_Adminhtml_CustomerController extends Mage_Adminhtml_CustomerController {
    ...
    public function saveAction()
    {
        ...
        if ($data) {
            ...
            if (isset($data['customer_products'])) {
                $products = array();
                parse_str($data['customer_products'], $products);
                $products = implode(',', array_keys($products));
                $customer->setData('product_ids', $products);
            }
    ...
    {
        if (!$customer = $this->_initCustomer('id')) {
            return;
        }
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('dt_customer/adminhtml_customer_edit_tab_product', 'customer.product.grid')
                ->toHtml()
        );
    }
}